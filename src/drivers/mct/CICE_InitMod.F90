...
!=======================================================================
  ...
  subroutine cice_init1(mpicom_ice)
  ...
  subroutine cice_init2()
    ...
    use ice_fileunits        , only: init_fileunits
    use ice_flux             , only: init_coupler_flux, init_history_therm, init_history_dyn, init_flux_atm, init_flux_ocn
    use ice_forcing          , only: init_forcing_ocn, init_forcing_atmo, get_forcing_atmo, get_forcing_ocn
    ...
    use ice_timers           , only: timer_total, ice_timer_start, ice_timer_stop
